...
abstract class AppLocalizations {
  ...
  /// No description provided for @themeDorodangoOrigins.
  ///
  /// In en, this message translates to:
  /// **'Dorodango Origins'**
  String get themeDorodangoOrigins;

  /// No description provided for @themeWabiSabi.
  ///
  /// In en, this message translates to:
  /// **'Wabi-Sabi'**
  String get themeWabiSabi;

  /// No description provided for @themeMa.
  ///
  /// In en, this message translates to:
  /// **'Ma (間)'**
  String get themeMa;

  /// No description provided for @themeKintsugi.
  ///
  /// In en, this message translates to:
  /// **'Kintsugi'**
  String get themeKintsugi;

  /// No description provided for @themeShokunin.
  ///
  /// In en, this message translates to:
  /// **'Shokunin'**
  String get themeShokunin;

  /// No description provided for @themeSoil.
  ///
  /// In en, this message translates to:
  /// **'Soil'**
  String get themeSoil;

  /// No description provided for @themePatience.
  ///
  /// In en, this message translates to:
  /// **'Patience'**
  String get themePatience;

  /// No description provided for @reflectionOrigins1Title.
  ///
  /// In en, this message translates to:
  /// **'Children of the Schoolyard'**
  String get reflectionOrigins1Title;

  /// No description provided for @reflectionOrigins1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionOrigins1Source.
  ///
  /// In en, this message translates to:
  /// **'Fumio Kayo, Kyoto University of Education'**
  String get reflectionOrigins1Source;

  /// No description provided for @reflectionOrigins2Title.
  ///
  /// In en, this message translates to:
  /// **'The Word Itself'**
  String get reflectionOrigins2Title;

  /// No description provided for @reflectionOrigins2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionOrigins2Source.
  ///
  /// In en, this message translates to:
  /// **'Japanese etymology'**
  String get reflectionOrigins2Source;

  /// No description provided for @reflectionOrigins3Title.
  ///
  /// In en, this message translates to:
  /// **'Bruce Gardner and the West'**
  String get reflectionOrigins3Title;

  /// No description provided for @reflectionOrigins3Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionOrigins3Source.
  ///
  /// In en, this message translates to:
  /// **'Bruce Gardner, dorodango.com'**
  String get reflectionOrigins3Source;

  /// No description provided for @reflectionOrigins4Title.
  ///
  /// In en, this message translates to:
  /// **'Earth as Mirror'**
  String get reflectionOrigins4Title;

  /// No description provided for @reflectionOrigins4Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionOrigins4Source.
  ///
  /// In en, this message translates to:
  /// **'Japanese aesthetic philosophy'**
  String get reflectionOrigins4Source;

  /// No description provided for @reflectionWabi1Title.
  ///
  /// In en, this message translates to:
  /// **'The Beauty of Imperfection'**
  String get reflectionWabi1Title;

  /// No description provided for @reflectionWabi1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionWabi1Source.
  ///
  /// In en, this message translates to:
  /// **'Leonard Koren, Wabi-Sabi: for Artists, Designers, Poets & Philosophers'**
  String get reflectionWabi1Source;

  /// No description provided for @reflectionWabi2Title.
  ///
  /// In en, this message translates to:
  /// **'Nothing Lasts'**
  String get reflectionWabi2Title;

  /// No description provided for @reflectionWabi2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionWabi2Source.
  ///
  /// In en, this message translates to:
  /// **'Richard Powell, Wabi Sabi Simple'**
  String get reflectionWabi2Source;

  /// No description provided for @reflectionWabi3Title.
  ///
  /// In en, this message translates to:
  /// **'Poverty of Means, Richness of Result'**
  String get reflectionWabi3Title;

  /// No description provided for @reflectionWabi3Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionWabi3Source.
  ///
  /// In en, this message translates to:
  /// **'Kakuzo Okakura, The Book of Tea'**
  String get reflectionWabi3Source;

  /// No description provided for @reflectionWabi4Title.
  ///
  /// In en, this message translates to:
  /// **'Seeing What Is Already There'**
  String get reflectionWabi4Title;

  /// No description provided for @reflectionWabi4Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionWabi4Source.
  ///
  /// In en, this message translates to:
  /// **'Soetsu Yanagi, The Beauty of Everyday Things'**
  String get reflectionWabi4Source;

  /// No description provided for @reflectionMa1Title.
  ///
  /// In en, this message translates to:
  /// **'The Space Between'**
  String get reflectionMa1Title;

  /// No description provided for @reflectionMa1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionMa1Source.
  ///
  /// In en, this message translates to:
  /// **'Arata Isozaki, MA: Space-Time in Japan'**
  String get reflectionMa1Source;

  /// No description provided for @reflectionMa2Title.
  ///
  /// In en, this message translates to:
  /// **'Emptiness Is Not Nothing'**
  String get reflectionMa2Title;

  /// No description provided for @reflectionMa2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionMa2Source.
  ///
  /// In en, this message translates to:
  /// **'Lao Tzu, Tao Te Ching (Chapter 11), via Japanese interpretation'**
  String get reflectionMa2Source;

  /// No description provided for @reflectionKintsugi1Title.
  ///
  /// In en, this message translates to:
  /// **'Gold in the Cracks'**
  String get reflectionKintsugi1Title;

  /// No description provided for @reflectionKintsugi1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionKintsugi1Source.
  ///
  /// In en, this message translates to:
  /// **'Christy Bartlett, Flickwerk: The Aesthetics of Mended Japanese Ceramics'**
  String get reflectionKintsugi1Source;

  /// No description provided for @reflectionKintsugi2Title.
  ///
  /// In en, this message translates to:
  /// **'Stronger at the Broken Places'**
  String get reflectionKintsugi2Title;

  /// No description provided for @reflectionKintsugi2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionKintsugi2Source.
  ///
  /// In en, this message translates to:
  /// **'Japanese craft philosophy'**
  String get reflectionKintsugi2Source;

  /// No description provided for @reflectionShokunin1Title.
  ///
  /// In en, this message translates to:
  /// **'The Craftsman\'s Spirit'**
  String get reflectionShokunin1Title;

  /// No description provided for @reflectionShokunin1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionShokunin1Source.
  ///
  /// In en, this message translates to:
  /// **'Tashio Odate, Japanese Woodworking Tools'**
  String get reflectionShokunin1Source;

  /// No description provided for @reflectionShokunin2Title.
  ///
  /// In en, this message translates to:
  /// **'Ten Thousand Hours of Earth'**
  String get reflectionShokunin2Title;

  /// No description provided for @reflectionShokunin2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionShokunin2Source.
  ///
  /// In en, this message translates to:
  /// **'Japanese apprenticeship tradition'**
  String get reflectionShokunin2Source;

  /// No description provided for @reflectionShokunin3Title.
  ///
  /// In en, this message translates to:
  /// **'The Dust Speaks'**
  String get reflectionShokunin3Title;

  /// No description provided for @reflectionShokunin3Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionShokunin3Source.
  ///
  /// In en, this message translates to:
  /// **'Material science of dorodango'**
  String get reflectionShokunin3Source;

  /// No description provided for @reflectionShokunin4Title.
  ///
  /// In en, this message translates to:
  /// **'The Polisher\'s Touch'**
  String get reflectionShokunin4Title;

  /// No description provided for @reflectionShokunin4Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionShokunin4Source.
  ///
  /// In en, this message translates to:
  /// **'Japanese sword polishing tradition (togishi)'**
  String get reflectionShokunin4Source;

  /// No description provided for @reflectionSoil1Title.
  ///
  /// In en, this message translates to:
  /// **'A World Beneath Your Feet'**
  String get reflectionSoil1Title;

  /// No description provided for @reflectionSoil1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionSoil1Source.
  ///
  /// In en, this message translates to:
  /// **'David Montgomery, Dirt: The Erosion of Civilizations'**
  String get reflectionSoil1Source;

  /// No description provided for @reflectionSoil2Title.
  ///
  /// In en, this message translates to:
  /// **'Clay Remembers'**
  String get reflectionSoil2Title;

  /// No description provided for @reflectionSoil2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionSoil2Source.
  ///
  /// In en, this message translates to:
  /// **'Soil science, clay mineralogy'**
  String get reflectionSoil2Source;

  /// No description provided for @reflectionPatience1Title.
  ///
  /// In en, this message translates to:
  /// **'The Slow Reveal'**
  String get reflectionPatience1Title;

  /// No description provided for @reflectionPatience1Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionPatience1Source.
  ///
  /// In en, this message translates to:
  /// **'Mihaly Csikszentmihalyi, Flow'**
  String get reflectionPatience1Source;

  /// No description provided for @reflectionPatience2Title.
  ///
  /// In en, this message translates to:
  /// **'What the Hands Know'**
  String get reflectionPatience2Title;

  /// No description provided for @reflectionPatience2Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @reflectionPatience2Source.
  ///
  /// In en, this message translates to:
